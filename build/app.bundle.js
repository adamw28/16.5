...

    {
      ...
      var validateProperty$1 = function validateProperty$1(tagName, name, value, canUseEventSystem) {
        ...
        if (lowerCasedName === 'is' && value !== null && value !== undefined && typeof value !== 'string') {
          warning(false, 'Received a `%s` for a string attribute `is`. If this is expected, cast ' + 'the value to a string.%s', typeof value === 'undefined' ? 'undefined' : _typeof(value), getStackAddendum$2());
          warnedProperties$1[name] = true;
          return true;
        }
...

    {
      ...
      var warnForInvalidEventListener = function warnForInvalidEventListener(registrationName, listener) {
        if (listener === false) {
          ...
          warning(false, 'Expected `%s` listener to be a function, instead got a value of `%s` type.%s', registrationName, typeof listener === 'undefined' ? 'undefined' : _typeof(listener), getCurrentFiberStackAddendum$2());
        }
      };
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function removeTodo(id) {
            console.log('state', this.state, ' id ', id);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                ' ',
                _react2.default.createElement(TodoList, { todos: this.state.todos, remove: this.removeTodo.bind(this) })
            );
        }
    }]);
